...
// function getCategorySlug(article: any) {
...
export default async function ArticleDetailPage({
  ...
  const shareUrl = encodeURIComponent(`${siteUrl}/articles/${category}/${article.slug}`)
                ...
                return (
                  <div key={rel.id} className="news-card">
                    <div className="image-wrapper">
                      ...
                      <div className="badge">
                        {Array.isArray(rel.articleType) && typeof rel.articleType[0] === 'object'
                          ? rel.articleType[0].name
                          : ''}
                      </div>
                    </div>
                    <div className="news-title">
                      <Link href={
                        rel.mediaType === 'image'
                          ? `/articles/${relCategory}/${rel.slug}`
                          : `/videos/${relCategory}/${rel.slug}`
                      }>
                        {rel.title}
                      </Link>
                    </div>
