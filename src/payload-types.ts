...
export interface Page {
  ...
  layout: (
    ...
    | {
        leftType: 'videos' | 'articles';
        leftArticleCategory?: (number | null) | ArticleCategory;
        leftArticleLimit?: number | null;
        rightArticleCategory: number | ArticleCategory;
        rightArticleLimit: number;
        sortBy?: ('publishedDate' | 'views') | null;
        id?: string | null;
        blockName?: string | null;
        blockType: 'mediaGridSection';
      }
    | {
        layout: 'full' | 'half' | 'leftFixed' | 'rightFixed';
        fullWidthBlocks?:
          | (
              | {
                  featuredArticles: (number | Article)[];
        ...
        leftColumn?:
          | (
              ...
              | {
                  ...
                  id?: string | null;
                  blockName?: string | null;
                  blockType: 'entertainmentArticles';
                }
              | {
                  title: string;
                  articleCategory: number | ArticleCategory;
              ...
              | {
                  ...
                  id?: string | null;
                  blockName?: string | null;
                  blockType: 'homeSectionBusinessOpinion';
                }
              | {
                  title: string;
                  articleCategory: number | ArticleCategory;
    ...
    | {
        ...
        id?: string | null;
        blockName?: string | null;
        blockType: 'webStories';
      }
    | {
        title: string;
        /**
         * Select article category (ID will be used internally)
         */
        category: number | ArticleCategory;
        id?: string | null;
        blockName?: string | null;
        blockType: 'latestNationalNews';
      }
  )[];
  meta?: {
    title?: string | null;
  ...
  layout?:
    ...
    | {
        ...
        mediaGridSection?:
          ...
          | {
              leftType?: T;
              leftArticleCategory?: T;
              leftArticleLimit?: T;
              rightArticleCategory?: T;
              rightArticleLimit?: T;
              sortBy?: T;
              id?: T;
              blockName?: T;
